...
export const data = {
    name: "ttsettingsbtntextedit",
    description: "Buton ismini günceller",
    cooldown: 5,
    async execute(interaction) {
        ...
        const buttonName = interaction.components[0].components[0].value;
        ...
        await Ticket_Schema.updateOne({ guild_id: interaction.guild.id }, { $set: { buttonName: buttonName } }, { upsert: true })
            .then(() => {
                response
                    .setDescription(`**Buton İsmi** başarılı bir şekilde güncellendi.\n\n${buttonName}`)
                    .setColor("Green")
